...
import com.serviceimpl.EditServiceImpl;
...
public class EditServlet extends HttpServlet {
	...
	//	System.out.println(Class);
		...
		EditServiceImpl e=new EditServiceImpl();
		int i=e.editService(vid, vehiclename, chassy, reg, permit, Vehicle_Type, Class, HeavyType, FuelType, Manufacturecompany, Vendor, Insuranceno, s, ava, PaymentId);
		if(i!=0)
		{
